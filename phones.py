...
file called phonesDatabase.csv.  It is run from the command line and is menu
...
def save_phone_list():
    ...
    f = open("phonesDatabase.csv", 'w', newline='')
    for item in phones:
        csv.writer(f).writerow(item)
    f.close()
  
def load_phone_list():
    if os.access("phonesDatabase.csv",os.F_OK):
        f = open("phonesDatabase.csv")
